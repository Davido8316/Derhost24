<?php
   ...
   $BILLING_URL = "//client.derHost24.de";
   $notification = true;
...
<html lang="de">
   <head>
      ...
      <link rel="stylesheet" type="text/css" loading="lazy" href="css/bootstrap.min.css">
      <link rel="stylesheet" type="text/css" loading="lazy" href="css/fontawesome-all.min.css">
      <link rel="stylesheet" type="text/css" loading="lazy" href="css/slick.css">
      <link rel="stylesheet" type="text/css" loading="lazy" href="css/style.css">
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="navbar-header">
                        <button aria-expanded="false" aria-label="Open menu" type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs">
                     ...
                     <div style="height: 1px;" role="main" aria-expanded="false"
                        ...
                        <ul class="nav navbar-nav navbar-nav-centered">
                              ...
                              <div class="dropdown-menu custom-dropdown-menu">
                                 <div class="dropdown-items-holder">
                                    <div class="items-with-icon">
                                       <div class="row">
                                          <div class="col-xs-12 col-sm-6">
                                             <a href="webspace" class="link-with-icon">
                                             <span class="icon"><img src="images/server1.svg" alt=""></span>
                                             <span class="text">SSD Webspace</span>
                                             </a>
                                             <a href="minecraft" class="link-with-icon">
                                             <span class="icon"><img src="images/server3.svg" alt=""></span>
                                             <span class="text">Minecraft Server</span>
                                             </a>
                                          </div>
                                          <div class="col-xs-12 col-sm-6">
                                             <a href="#whmcs/cart.php?a=add&amp;domain=register" class="link-with-icon">
                                    ...
                                    <div class="items">
                                       <div class="row">
                                          <div class="col-xs-12 col-sm-6">
                                             <a href="#" class="link disabled">Discord Bot Hosting (Soon)</a>
                                          </div>
                                          <div class="col-xs-12 col-sm-6">
                                             <a href="#" class="link disabled">VPS Hosting (Soon)</a>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                           ...
                           <li class="nav-item dropdown">
                              <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">&#128274 Login</a>
                              <div class="dropdown-menu custom-dropdown-menu">
                                 <div class="dropdown-items-holder">
                                    <div class="items-with-icon">
                                       <div class="row">
                                    ...
                                    <div class="items">
                                       <div class="row">
                                          <div class="col-xs-12 col-sm-8">
                                             <a href="#" class="link disabled">100% verschlüsselt. <br> Deine Daten sind sicher.</a>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
